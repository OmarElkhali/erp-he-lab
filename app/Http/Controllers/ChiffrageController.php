...
public function calculerCoutTotal(Demande $demande)
    {
        ...
        // 🔹 Frais de déplacement UNIQUES par ville (commun à toute la demande)
        $C6_total = 0;
        $villesDejaCalculees = [];
        ...
        // 🔹 NOUVELLE LOGIQUE : CHAQUE POSTE EST CALCULÉ INDÉPENDAMMENT
        ...
        return [
            ...
            'detail' => [
                // COÛTS FIXES PAR DEMANDE (COMMUNS)
                'C4_rapport' => $C4,
                'C5_logistique' => $C5,
            ...
            'regles_appliquees' => [
                ...
                'C4 (Rapport)' => $C4 . ' MAD fixe par demande (commun)',
                'C5 (Logistique)' => $C5 . ' MAD fixe par demande (commun)',
                'C6 (Déplacement)' => 'Frais de déplacement UNIQUES par ville (commun)'
            ],
            'resume' => [
